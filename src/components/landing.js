...
const LandingPage = ({ mintAddr, setPage }) => {
  return (
    <ThemeProvider theme={theme}>
      <Box
        sx={{
          minHeight: '100vh', // fix height to viewport height
        ...
        <Box
          sx={{
            ...
            width: {
              ...
              md: 560,      // fixed width on medium and up (desktop)
            },
            maxWidth: 560,  // never exceed 560px
            mx: 'auto',     // center horizontally
            aspectRatio: '16/9', // modern browsers, keeps 16:9 ratio
            my: 3,          // vertical margin
            zIndex: 2,
          }}
        >
          <iframe
            src="https://www.youtube.com/embed/K9dfwkEpqfE?si=uD0qe_A5xiOqQm70"
